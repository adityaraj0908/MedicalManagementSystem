...
public class Edit_Patient extends JFrame implements ActionListener
{
    ...
    Edit_Patient(String username)
    {
        try
        {
            ...
            if(rest0.next())
            {
                ...
                ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Hospital/Icons/add_patient_details.jpg"));
                ...
                try
                {
                    ...
                    while(rest.next())
                    {
                        ...
                        tf4.setText(rest.getString("email"));
                        l1.add(tf4);

                        tf5 = new JTextField();
                        tf5.setBounds(200,250,150,30);
                        tf5.setText(rest.getString("father_name"));
                        l1.add(tf5);
                        ...
                        tf7.setText(rest.getString("marital_status"));
                        l1.add(tf7);
                        ...
                        tf11.setText(rest.getString("disease"));
                        l1.add(tf11);
                        ...
                        tf12.setText(rest.getString("age"));
                        l1.add(tf12);
                        ...
                        tf13.setText(rest.getString("address"));
                        l1.add(tf13);


                        tf14 = new JTextField();
                        tf14.setBounds(200,450,150,30);
                        tf14.setText(rest.getString("DOB"));
                        l1.add(tf14);
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==bt1)
        {
            ...
            String fname = tf5.getText();
            String phone = tf6.getText();
            String marital_status = tf7.getText();
            String city = tf8.getText();
            String gender = tf9.getText();
            String blood = tf10.getText();
            String disease = tf11.getText();
            String age = tf12.getText();
            String address = tf13.getText();
            String dob = tf14.getText();
            try
            {
                ConnectionClass obj = new ConnectionClass();
                String q = "update patient set name='"+name+"',email='"+email+"',father_name='"+fname+"',phone='"+phone+"',marital_status='"+marital_status+"',city='"+city+"',gender='"+gender+"',blood='"+blood+"',age='"+age+"',DOB='"+dob+"',disease='"+disease+"',disease='"+disease+"',address='"+address+"' where username ='"+username+"'";
