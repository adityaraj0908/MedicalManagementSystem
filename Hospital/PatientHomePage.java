...
public class PatientHomePage extends JFrame implements ActionListener 
{
    ...
    PatientHomePage(String patientname,String patient_id,int login_id,String username)
    {
        ...
        ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("Hospital/Icons/patient_homepage.jpg"));
...
//        JMenuItem men3t2 = new JMenuItem("View Receptionist");
        ...
        JMenu men5 = new JMenu("Hi Patient("+patientname+")");
...
//        {
//            new Check_My_Profile(patientid2,login__id);
//        }
