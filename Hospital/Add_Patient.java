...
public class Add_Patient implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==bt1)
        {
            ...
            Random r = new Random();
            String patient_id = ""+Math.abs(r.nextInt() % 100000);
            try
            {
                ConnectionClass obj = new ConnectionClass();
                String q = "insert into patient values('"+patient_id+"','"+name+"','"+username+"','"+password+"','"+email+"','"+fname+"','"+phone+"','"+marital_status+"','"+city+"','"+gender+"','"+blood+"','"+disease+"','"+age+"','"+address+"','"+dob+"')";
